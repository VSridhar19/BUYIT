...
public class AdapterLaptops extends RecyclerView.Adapter<AdapterLaptops.Viewholder> {
    String[] name1, names1;
    int[] images1;
    Context ct;
    public AdapterLaptops(Laptops mainActivity,String[] name1,String[] names1,int[] images1){
        this.name1=name1;
    ...
    @Override
    public AdapterLaptops.Viewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item, parent, false);
        return new Viewholder(v);
    }

    @Override
    public void onBindViewHolder(AdapterLaptops.Viewholder holder, int position) {
