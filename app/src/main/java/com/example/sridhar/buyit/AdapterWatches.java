...
public class AdapterWatches extends RecyclerView.Adapter<AdapterWatches.Viewholder> {
    String[] name1, names1;
    int[] images1;
    Context ct;

    public AdapterWatches(Watches mainActivity, String[] name1, String[] names1, int[] images1) {
        this.name1 = name1;
    ...
    @Override
    public AdapterWatches.Viewholder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AdapterWatches.Viewholder holder, int position) {
