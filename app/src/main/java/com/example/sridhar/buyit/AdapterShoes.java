...
/**
 * Created by Sridhar on 24-03-2018.<Myadapter.Viewholder> {
 */

class AdapterShoes extends RecyclerView.Adapter<AdapterShoes.Viewholder> {
    String[] name1, names1;
    int[] images1;
    Context ct;
    ...
    public AdapterShoes(Shoes mainActivity, String[] name1, String[] names1, int[] images1) {
        this.name1=name1;
